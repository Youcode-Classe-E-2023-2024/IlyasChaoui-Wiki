...
<nav class="relative mx-10 mb-32 rounded-b-2xl px-4 py-4 flex justify-between items-center bg-white">
    ...
    <form>
        <div class=" hidden md:flex w-full" style="width: 600px; height: 40px">
            <label for="search-dropdown" class="mb-2 text-xl font-medium text-gray-900 sr-only dark:text-white">Your Email</label>
            <select name="" id="" class="w-fit border-1 bg-gray-300 pl-4 font-bold uppercase rounded-l-2xl text-xl p-1 ">
                <option value="">test</option>
                <option value="">tes2</option>
                <option value="">test3</option>
            </select>
            <div class="relative w-full">
                <input type="search" id="search-dropdown" style="height: 40px" class="block p-2.5 w-full z-20 text-2xl text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search Mockups, Logos, Design Templates..." required>
...
<div class="navbar-menu relative z-50 hidden">
    ...
    <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
        ...
        <div class="flex flex-col" style="width: 200px; height: 30px">
            <label for="search-dropdown" class="mb-2 text-xl font-medium text-gray-900 sr-only dark:text-white">Your Email</label>
            <select name="" id="" class="w-fit mb-4 border-1 bg-gray-300 pl-4 font-bold uppercase rounded-xl text-xl p-1 ">
                <option value="">test</option>
                <option value="">tes2</option>
                <option value="">test3</option>
            </select>
