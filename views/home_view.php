<div class="container">
    ...
    <header>
        ...
        <nav>
            <img src="assets/images/main-logo.png" alt="Main Site Logo">

            <div class="mobileMenuIcon_open">
                <span class="iconify" data-icon="eva:menu-arrow-fill"></span>
            </div>

            <div class="mobileMenuIcon_close">
                <span class="iconify" data-icon="line-md:close"></span>
            </div>
            ...
            <ul>
                ...
                <li><a href="#">Randomness <span class="iconify" data-icon="dashicons:arrow-down-alt2"></span> </a></li>
